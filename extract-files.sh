...
adb pull /system/lib/libdivxdrmdecrypt.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/lib
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/lib/libomx_sharedlibrary.so:system/lib/libomx_sharedlibrary.soso
